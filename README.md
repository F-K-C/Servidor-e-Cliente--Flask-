Computação Quântica para Defesa Cibernética - Fabrício Kolk; Rafael Servo
...
export LD_LIBRARY_PATH=$HOME/Desktop/PQCnovo/openssl-3.5/lib64:$LD_LIBRARY_PATH export PATH=$HOME/Desktop/PQCnovo/openssl-3.5/bin:$PATH
